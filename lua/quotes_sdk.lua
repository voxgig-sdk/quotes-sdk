...
QuotesSDK._make_feature = _make_feature


function QuotesSDK.new(options)
  local self = setmetatable({}, QuotesSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function QuotesSDK:options_map()
...
function QuotesSDK:get_utility()
  return Utility.copy(self._utility)
end


function QuotesSDK:get_root_ctx()
  return self._rootctx
end


function QuotesSDK:prepare(fetchargs)
...
function QuotesSDK:direct(fetchargs)
...
-- by passing it.
function QuotesSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function QuotesSDK:graphql(query, variables, ctrl)
...
function QuotesSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = QuotesSDK.new(sdkopts)
  sdk.mode = "test"
