...
from quotes_sdk.utility.voxgig_struct import voxgig_struct as vs
from quotes_sdk import QuotesSDK
from quotes_sdk.core.spec import QuotesSpec
from quotes_sdk.core.result import QuotesResult
from quotes_sdk.core.response import QuotesResponse
from quotes_sdk.core.operation import QuotesOperation
from quotes_sdk.core.error import QuotesError
from quotes_sdk.core import helpers
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = QuotesSDK.test(None, None)
        ...
        class TestInitFeature(QuotesBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(QuotesBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = QuotesSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = QuotesSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = QuotesSDK.test(None, setup_opts)
