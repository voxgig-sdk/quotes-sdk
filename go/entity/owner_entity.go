...
import (
	...
	vs "github.com/voxgig-sdk/quotes-sdk/go/utility/struct"
)

type OwnerEntity struct {
	name    string
	client  *core.QuotesSDK
...
func NewOwnerEntity(client *core.QuotesSDK, entopts map[string]any) *OwnerEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OwnerEntity) GetName() string { return e.name }
...
func (e *OwnerEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OwnerEntity) Deleted() bool {
	return e.deleted
}


func (e *OwnerEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOwnerEntity(e.client, opts)
}

func (e *OwnerEntity) Data(args ...any) any {
...
func (e *OwnerEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Owner; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *OwnerEntity) DataTyped(data ...Owner) Owner {
	if len(data) > 0 {
		return typedFrom[Owner](e.Data(asMap(data[0])))
	}
	return typedFrom[Owner](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Owner (all fields
// optional at the wire level).
func (e *OwnerEntity) MatchTyped(match ...Owner) Owner {
	if len(match) > 0 {
		return typedFrom[Owner](e.Match(asMap(match[0])))
	}
	return typedFrom[Owner](e.Match())
}
...
func (e *OwnerEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OwnerEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// OwnerLoadMatch and returns an Owner. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *OwnerEntity) LoadTyped(reqmatch OwnerLoadMatch, ctrl map[string]any) (Owner, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Owner{}, err
	}
	return typedFrom[Owner](res), nil
}



func (e *OwnerEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *OwnerEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *OwnerEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *OwnerEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *OwnerEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
