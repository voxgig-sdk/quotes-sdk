...
type Args struct {
	Entity string         `json:"entity" jsonschema:"owner | quote"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.QuotesSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "quotes_list",
		Description: "List records from Quotes. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "quotes_load",
		Description: "Load a single record from Quotes. " +
...
func runOp(client *sdk.QuotesSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.QuotesSDK, name string) (sdk.QuotesEntity, error) {
	switch strings.ToLower(name) {
	case "owner":
		return client.Owner(nil), nil
	case "quote":
