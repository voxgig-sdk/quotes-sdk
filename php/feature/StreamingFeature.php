...
class QuotesStreamingFeature extends QuotesBaseFeature
{
    ...
    private function _iterate(QuotesResult $result): \Generator
    {
    ...
    private function _streamable(QuotesContext $ctx): bool
    {
