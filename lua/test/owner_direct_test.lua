...
describe("OwnerDirect", function()
  it("should direct-load-owner", function()
    local setup = owner_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-owner", setup.live and "live" or "unit")
...
function owner_direct_setup(mockres)
