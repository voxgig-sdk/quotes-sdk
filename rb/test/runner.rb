...
module QuotesTestRunner
  ...
  def self.env_override(m)
    live = getenv("QUOTES_TEST_LIVE")
    override = getenv("QUOTES_TEST_OVERRIDE")
    ...
    explain = getenv("QUOTES_TEST_EXPLAIN")
    m["QUOTES_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = QuotesTestRunner
Helpers = QuotesHelpers
Vs = VoxgigStruct
