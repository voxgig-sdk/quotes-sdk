...
class QuotesNetsimFeature extends QuotesBaseFeature
{
    ...
    private function _simulate(QuotesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(QuotesContext $ctx, array $applied): void
    {
        $client = $this->client;
