...
// Quotes SDK clienttrack feature
...
class QuotesClienttrackFeature extends QuotesBaseFeature
{
    ...
    public function PostConstruct(QuotesContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Quotes-SDK';
