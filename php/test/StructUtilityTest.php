...
// Quotes SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = QuotesOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(QuotesOmni::structfix($now, Struct::undef()))
                        !== json_encode(QuotesOmni::structfix($val, Struct::undef()))) {
