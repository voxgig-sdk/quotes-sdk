...
// Quotes SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class QuotesTestFeature extends QuotesBaseFeature
{
    ...
    public function init(QuotesContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (QuotesContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (QuotesContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(QuotesContext $ctx, $op, $args): array
    {
