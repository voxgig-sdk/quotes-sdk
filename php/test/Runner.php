...
class QuotesTestRunner
{
    ...
    {
        $live = self::getenv('QUOTES_TEST_LIVE');
        $override = self::getenv('QUOTES_TEST_OVERRIDE');
        ...
        $explain = self::getenv('QUOTES_TEST_EXPLAIN');
...
class_alias('QuotesTestRunner', 'Runner');
class_alias('QuotesHelpers', 'Helpers');
