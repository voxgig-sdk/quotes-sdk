...
class QuotesTimeoutFeature extends QuotesBaseFeature
{
    ...
    private function _with_timeout(QuotesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(QuotesContext $_ctx, float $ms): void
    {
        $client = $this->client;
