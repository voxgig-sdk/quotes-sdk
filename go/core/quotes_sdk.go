...
func (sdk *QuotesSDK) OptionsMap() map[string]any {
...
func (sdk *QuotesSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *QuotesSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *QuotesSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *QuotesSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *QuotesSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *QuotesSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("QuotesSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *QuotesSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *QuotesSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("QuotesSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
