# Quotes SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions QuotesSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both QuotesSDK(...) and QuotesSDK.test(...) become
#      QuotesSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "quotes_sdk"
_SDK_CLASS = "QuotesSDK"
