...
class QuotesCacheFeature extends QuotesBaseFeature
{
    ...
    private function _through(QuotesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
