...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/quotes` | `npm install @voxgig-sdk/quotes` |
| Python | `voxgig-sdk-quotes` | `pip install voxgig-sdk-quotes` |
| PHP | `voxgig-sdk/quotes` | `composer require voxgig-sdk/quotes` |
| Golang | `github.com/voxgig-sdk/quotes-sdk/go` | `go get github.com/voxgig-sdk/quotes-sdk/go` |
| Ruby | `voxgig-sdk-quotes` | `gem install voxgig-sdk-quotes` |
| Lua | `voxgig-sdk-quotes` | `luarocks install voxgig-sdk-quotes` |
