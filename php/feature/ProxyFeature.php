...
class QuotesProxyFeature extends QuotesBaseFeature
{
    ...
    public function init(QuotesContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (QuotesContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
