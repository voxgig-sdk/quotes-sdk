...
class QuotesRbacFeature extends QuotesBaseFeature
{
    ...
    private function _required(QuotesContext $ctx): ?string
    {
    ...
    private function _reject(QuotesContext $ctx, string $required): void
    {
    ...
    private function _track(QuotesContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
