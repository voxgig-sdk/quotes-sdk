...
from quotes_sdk.core.control import QuotesControl
...
from quotes_sdk.core.helpers import get_ctx_prop, to_map
...
class QuotesContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, QuotesResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return QuotesError(code, msg, self)
