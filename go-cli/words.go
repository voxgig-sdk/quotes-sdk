...
func registerSDKWords(r *eng.Registry, client *sdk.QuotesSDK) {
...
func runOp(client *sdk.QuotesSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
