...
class QuotesFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; QuotesSDK/1.0)';
    ...
    public static function call(QuotesContext $ctx, string $fullurl, array $fetchdef): array
    {
