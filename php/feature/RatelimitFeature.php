...
class QuotesRatelimitFeature extends QuotesBaseFeature
{
    ...
    private function _acquire(QuotesContext $ctx): void
    {
    ...
    private function _track(QuotesContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
