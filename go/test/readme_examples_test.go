...
const testSeed = `map[string]any{"entity": map[string]any{"owner": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "quote": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
