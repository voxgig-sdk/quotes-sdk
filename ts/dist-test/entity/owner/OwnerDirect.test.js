...
(0, node_test_1.describe)('OwnerDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-owner', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-owner', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.QUOTES_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.QuotesSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['QUOTES_TEST_OWNER_ENTID'];
    ...
    const client = new __1.QuotesSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=OwnerDirect.test.js.map