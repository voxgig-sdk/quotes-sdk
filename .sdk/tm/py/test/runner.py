...
class QuotesTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = QuotesTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = QuotesTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = QuotesTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
