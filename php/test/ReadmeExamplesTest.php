...
// Quotes SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (QuotesSDK::test)
...
{
    private const SDK_CLASS = 'QuotesSDK';
    ...
    private const SDK_BASE = 'quotes_sdk';
