...
// Quotes SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class QuotesMakeRequest
{
    public static function call(QuotesContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new QuotesResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new QuotesResponse($fetched);
        } else {
