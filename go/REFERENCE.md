# Quotes Golang SDK Reference

Complete API reference for the Quotes Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *QuotesSDK`
...
#### `Owner(data map[string]any) QuotesEntity`

Create a new `Owner` entity instance. Pass `nil` for no initial data.

#### `Quote(data map[string]any) QuotesEntity`
