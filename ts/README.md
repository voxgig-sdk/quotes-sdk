# Quotes TypeScript SDK



The TypeScript SDK for the Quotes API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Owner()` — each with a small set of operations (`list`, `load`)
...
| `tester(testopts?, sdkopts?)` | `QuotesSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `QuotesSDK.test(testopts?, sdkopts?)` | `QuotesSDK` | Create a test-mode client. |
...
| `client` | `client(): QuotesSDK` | Return the parent SDK client. |
