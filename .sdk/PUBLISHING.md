...
|---|---|---|
| `ts/` | @voxgig-sdk/quotes-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/quotes-sdk \
      --repository voxgig-sdk/quotes-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/quotes-sdk` shows it, and
`npm trust revoke @voxgig-sdk/quotes-sdk --id=<id>` removes it.
