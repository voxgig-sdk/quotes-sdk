# Quotes TypeScript SDK Reference

Complete API reference for the Quotes TypeScript SDK.
...
#### `QuotesSDK.test(testopts?, sdkopts?)`
...
**Returns:** `QuotesSDK` instance in test mode.
...
Create a new `Owner` entity instance.
...
Return the parent `QuotesSDK` instance.
