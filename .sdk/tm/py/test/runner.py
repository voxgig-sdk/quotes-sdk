...
class QuotesTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = QuotesTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = QuotesTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = QuotesTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
