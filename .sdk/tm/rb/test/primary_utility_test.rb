...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = QuotesOmni.make_runner(TEST_JSON_FILE, QuotesSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : QuotesOmni.errify(err)
    end
