...
from quotes_sdk.utility import register

# Load features
from quotes_sdk.feature.base_feature import QuotesBaseFeature
from quotes_sdk.features import _has_feature, _make_feature
...
class QuotesSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = QuotesUtility()
        self._utility = utility

        from quotes_sdk.config import shared_config
    ...
    def get_utility(self):
        return QuotesUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("QuotesSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Owner(self, data=None) -> "OwnerEntity":
        ...
        from quotes_sdk.entity.owner_entity import OwnerEntity
        return OwnerEntity(self, data)


    def Quote(self, data=None) -> "QuoteEntity":
        """Entity factory: client.Quote().list() / client.Quote().load({"id": ...})."""
        from quotes_sdk.entity.quote_entity import QuoteEntity
        return QuoteEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "QuotesSDK":
        if sdkopts is None:
            sdkopts = {}
