...
(0, node_test_1.describe)('OwnerEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/owner/OwnerTestData.json');
    ...
    let idmap = transform(['owner01', 'owner02', 'owner03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=OwnerEntity.test.js.map